...
namespace ATM
{
    internal class Transferencias
    {
        ...
        public void Traferir(Transferencias Tra, Transacciones Trans, Cuentas Origen, Cuentas Destino) {
            ...
            SqlCommand cmd = new SqlCommand("INSERT INTO Transsacciones(Folio,CuentaOrigen,CuentaDestino,Fecha, Monto) VALUES(@Folio, @CuentaOrigen, @CuentaDestino, @Fecha, @Monto)", Conexionalabase);
